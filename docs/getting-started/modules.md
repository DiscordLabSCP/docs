...
You can also install a module by downloading the module from the [DiscordLab GitHub](https://github.com/DiscordLabSCP/DiscordLab) and placing it in the `LabApi/plugins` folder.
